    ...
    <AuthShell variant="ssp">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-foreground/55 leading-relaxed">
          Monetize your Web3 traffic with premium demand.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        >
          {loading ? (
            ...
            <>
              Get started as Publisher <ArrowRight size={16} />
            </>
          )}
        </button>
      </form>
      ...
      <p className="text-center mt-4 text-xs text-foreground/[0.42]">
        Looking to buy ads?{' '}
        <Link href="/dsp/sign-up" className="underline underline-offset-2 hover:text-foreground">
          Advertiser sign up (DSP)
        </Link>
      </p>
