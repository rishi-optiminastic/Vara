  ...
  return (
    <AuthShell variant="ssp">
      <div className="lg:hidden mb-6">
        <Link href="/ssp" className="flex items-center gap-2 group w-fit">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-foreground/55 leading-relaxed">
          Sign in to manage your publisher inventory
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="w-full px-3.5 py-2.5 bg-white border border-border text-foreground text-sm outline-none transition-all rounded-[6px] placeholder:text-foreground/[0.28] focus:border-foreground/[0.38] focus:shadow-[0_0_0_3px_rgba(55,50,47,0.05)]"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="flex justify-between items-center text-[11px] font-medium text-foreground/50 uppercase tracking-[0.07em]">
            <span>Password</span>
            <Link
              href="/forgot-password"
              className="text-foreground/50 text-xs font-normal normal-case tracking-normal hover:text-foreground transition-colors"
            >
              Forgot password?
            </Link>
          </label>
          <div className="relative">
            <input
              ...
              className="w-full pl-3.5 pr-10 py-2.5 bg-white border border-border text-foreground text-sm outline-none transition-all rounded-[6px] placeholder:text-foreground/[0.28] focus:border-foreground/[0.38] focus:shadow-[0_0_0_3px_rgba(55,50,47,0.05)]"
              placeholder="••••••••"
              required
              disabled={disabled}
            />
      ...
      <p className="text-center mt-4 text-xs text-foreground/[0.42]">
        Looking for the advertiser platform?{' '}
        <Link href="/dsp/sign-in" className="underline underline-offset-2 hover:text-foreground">
          DSP sign in
        </Link>
      </p>
