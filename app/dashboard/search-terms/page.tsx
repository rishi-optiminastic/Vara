...
const MATCH_STYLE: Record<MatchType, string> = {
  "wallet behavior": "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
  contract: "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
  chain: "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
  geo: "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
}

const STATUS_STYLE: Record<TermStatus, string> = {
  added: "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
  suggested: "bg-[#ECEAE2] text-[#1F40CD] border-[rgba(10,10,10,0.12)]",
  excluded: "bg-[rgba(10,10,10,0.06)] text-[#0A0A0A]/60 border-[rgba(10,10,10,0.16)]",
}
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-[rgba(10,10,10,0.05)]">
                {rows.map((t) => {
                  ...
                  return (
                    <tr key={`${t.matchType}:${t.term}`} className="hover:bg-[rgba(10,10,10,0.02)]">
    ...
    <div className="flex flex-col gap-3 p-3">
      ...
      <Card className="border-[rgba(10,10,10,0.12)]">
        <CardContent className="py-16 text-center">
          <p className="text-sm font-medium text-[#0A0A0A]">No targeting facets yet</p>
