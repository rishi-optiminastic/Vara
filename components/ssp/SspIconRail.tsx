...
import { SSP_NAV_SECTIONS } from "./SspNav"
  ...
  return (
    <div className="flex h-full w-12 shrink-0 flex-col border-r border-dashed border-[rgba(10,10,10,0.15)] bg-white">
      <div className="flex h-11 shrink-0 items-center justify-center border-b border-dashed border-[rgba(10,10,10,0.15)]">
        <Link
          href="/ssp/dashboard"
          className="flex h-7 w-7 items-center justify-center rounded-md bg-[#B45309] text-white text-[11px] font-bold shadow-[0_1px_0_rgba(0,0,0,0.06)]"
          title="Varaads SSP"
        >
          V
        </Link>
          ...
          return (
            <button
              ...
              className={`group relative flex h-9 w-9 items-center justify-center rounded-md transition-colors ${
                active
                  ? "bg-[#B45309] text-white shadow-[0_1px_0_rgba(0,0,0,0.06)]"
                  : "text-[#0A0A0A]/80 hover:bg-[#0A0A0A]/6 hover:text-[#0A0A0A]"
              }`}
            >
              {active && (
                <span className="absolute -left-1.75 top-1/2 h-4 w-0.5 -translate-y-1/2 rounded-full bg-[#B45309]" />
              )}
              <section.icon
      ...
      <div className="flex shrink-0 flex-col items-center gap-1 border-t border-dashed border-[rgba(10,10,10,0.15)] py-3">
        ...
        <div
          className="flex h-7 w-7 items-center justify-center rounded-full bg-[#B45309] text-white text-[10px] font-semibold cursor-default"
