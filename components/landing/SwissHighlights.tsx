...
export function SwissHighlights({
  ...
  return (
    <section className="relative w-full py-12 md:py-20 border-t border-[#37322F]/15">
      <div className="grid grid-cols-12 gap-x-6 items-start">
        ...
        {badge && (
          <div className="col-span-12 lg:col-span-3 mt-4 lg:mt-0 flex lg:justify-end">
      ...
      <AnimatedGrid className="mt-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        {items.map((h) => (
          <AnimatedItem key={h.title} className="flex flex-col">
