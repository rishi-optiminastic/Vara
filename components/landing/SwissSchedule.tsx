...
export function SwissSchedule({ heading, body, days }: SwissScheduleProps): JSX.Element {
  return (
    <section id="roadmap" className="relative w-full py-20 border-t border-[#37322F]/15">
      ...
      <div className="mt-12 space-y-12">
        {days.map((d) => (
          <div key={d.label}>
            <div className="bg-[#1f40cd] text-white px-6 py-5">
...
function ScheduleRowView({ row }: { row: ScheduleRow }): JSX.Element {
  return (
    <div className="grid grid-cols-12 gap-x-6 pb-6 border-b border-dashed border-[#37322F]/25">
      ...
      <dl className="col-span-12 md:col-span-5 grid grid-cols-2 gap-x-6 gap-y-1 text-[12px] mt-4 md:mt-0">
