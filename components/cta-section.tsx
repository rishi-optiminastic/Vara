        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          ...
          <div className="w-full max-w-[497px] flex flex-col justify-center items-center gap-12">
            <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4">
              ...
              <Link
                href="/early-access"
                className="h-10 px-8 sm:px-10 py-[6px] bg-white shadow-[0px_1px_2px_rgba(55,50,47,0.12)] overflow-hidden rounded-full flex justify-center items-center border border-[rgba(2,6,23,0.08)] text-[#37322F] text-[13px] font-medium leading-5 font-sans hover:bg-[#F0EEEB] transition-colors"
              >
