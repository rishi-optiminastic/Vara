...
export function AdGroupActions({ id, status }: Props): React.JSX.Element {
  ...
  return (
    <div className="flex items-center gap-1.5">
      {isPaused && (
        <Button size="sm" className="h-8 gap-1 text-xs rounded-full px-3.5 bg-[#0A0A0A] text-[#FFFFFF] hover:bg-[#0A0A0A] shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_1px_2px_rgba(10,10,10,0.18)]" disabled={busy} onClick={() => setStatus("ACTIVE")}>
